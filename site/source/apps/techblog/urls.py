...
urlpatterns = patterns('techblog.views',
    ...
    url(r'^articles/(?P<article_id>\d+)/edit/$', 'add_or_edit_article', name='edit_article'),
    url(r'^articles/(?P<article_id>\d+)/translate/$', 'translate_article', name='translate_article'),
