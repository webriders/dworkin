...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('techblog_category', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('slug', self.gf('django.db.models.fields.SlugField')(default='', max_length=64, db_index=True)),
        ))
        db.send_create_signal('techblog', ['Category'])

        # Adding field 'Article.category'
        db.add_column('techblog_article', 'category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['techblog.Category'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'Category'
        db.delete_table('techblog_category')

        # Deleting field 'Article.category'
        db.delete_column('techblog_article', 'category_id')
    ...
    models = {
        ...
        'techblog.article': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 6, 6, 20, 19, 29, 940000)'}),
