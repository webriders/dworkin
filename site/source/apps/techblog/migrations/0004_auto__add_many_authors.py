...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('techblog_article_authors', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('article', models.ForeignKey(orm['techblog.article'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('techblog_article_authors', ['article_id', 'user_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field authors on 'Article'
        db.delete_table('techblog_article_authors')
    ...
    models = {
        ...
        'techblog.article': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 6, 10, 12, 39, 33, 384000)'}),
