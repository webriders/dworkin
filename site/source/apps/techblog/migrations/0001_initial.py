...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('techblog_article', (
            ...
            ('date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 6, 6, 20, 18, 22, 572000))),
    ...
    models = {
        ...
        'techblog.article': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 6, 6, 20, 18, 22, 572000)'}),
